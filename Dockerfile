...
ENV SBPM_UPDATE_CHECK_DISABLED=false
ENV SBPM_UPDATE_CHECK_REPO=cheluen/singbox-proxy-manager
ENV SBPM_UPDATE_CHECK_TTL=6h
ENV SBPM_UPDATE_CHECK_TIMEOUT=5s
